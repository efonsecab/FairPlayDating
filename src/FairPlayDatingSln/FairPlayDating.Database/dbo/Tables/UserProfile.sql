...
(
	...
	[PreferredCurrentDateObjectiveId] SMALLINT NOT NULL,
	...
	CONSTRAINT [FK_UserProfile_PreferredEyesColor] FOREIGN KEY ([PreferredEyesColorId]) REFERENCES [EyesColor]([EyesColorId]),
	...
	CONSTRAINT [FK_UserProfile_PreferredCurrentDateObjectiveId] FOREIGN KEY ([PreferredCurrentDateObjectiveId]) REFERENCES [DateObjective]([DateObjectiveId]),
    CONSTRAINT [FK_UserProfile_ReligionId] FOREIGN KEY ([ReligionId]) REFERENCES [Religion]([ReligionId]),
	CONSTRAINT [FK_UserProfile_PreferredReligionId] FOREIGN KEY ([PreferredReligionId]) REFERENCES [Religion]([ReligionId]),
